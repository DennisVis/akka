...
class GraphFlexiRouteSpec extends AkkaSpec {
  ...
  "FlexiRoute" must {
    ...
    "build simple fair route" in checkThatAllStagesAreStopped {
    ...
    "support finish of downstreams and cancel of upstream" in checkThatAllStagesAreStopped {
    ...
    "support error of outputs" in checkThatAllStagesAreStopped {
      val fixture = new TestFixture
      import fixture._
    ...
    "support error of a specific output" in checkThatAllStagesAreStopped {
      val fixture = new TestFixture
      import fixture._
    ...
    "emit error for user thrown exception" in checkThatAllStagesAreStopped {
      val fixture = new TestFixture
      import fixture._
    ...
    "emit error for user thrown exception in onUpstreamFinish" in checkThatAllStagesAreStopped {
      val fixture = new TestFixture
      import fixture._
    ...
    "handle cancel from output" in checkThatAllStagesAreStopped {
      val fixture = new TestFixture
      import fixture._
    ...
    "handle finish from upstream input" in checkThatAllStagesAreStopped {
      val fixture = new TestFixture
      import fixture._
    ...
    "handle error from upstream input" in checkThatAllStagesAreStopped {
      val fixture = new TestFixture
      import fixture._
    ...
    "cancel upstream input when all outputs cancelled" in checkThatAllStagesAreStopped {
      val fixture = new TestFixture
      import fixture._
    ...
    "cancel upstream input when all outputs completed" in checkThatAllStagesAreStopped {
      val fixture = new TestFixture
      import fixture._
