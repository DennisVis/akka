...
class GraphBroadcastSpec extends AkkaSpec {
  ...
  "A broadcast" must {
    ...
    "broadcast to other subscriber" in checkThatAllStagesAreStopped {
    ...
    "produce to other even though downstream cancels" in checkThatAllStagesAreStopped {
      val c1 = StreamTestKit.SubscriberProbe[Int]()
      val c2 = StreamTestKit.SubscriberProbe[Int]()
    ...
    "produce to downstream even though other cancels" in checkThatAllStagesAreStopped {
      val c1 = StreamTestKit.SubscriberProbe[Int]()
      val c2 = StreamTestKit.SubscriberProbe[Int]()
