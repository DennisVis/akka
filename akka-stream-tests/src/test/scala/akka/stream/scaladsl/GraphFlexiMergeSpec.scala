...
class GraphFlexiMergeSpec extends AkkaSpec {
  ...
  "FlexiMerge" must {
    ...
    "build simple fair merge" in checkThatAllStagesAreStopped {
    ...
    "be able to have two fleximerges in a graph" in checkThatAllStagesAreStopped {
    ...
    "support cancel of input" in checkThatAllStagesAreStopped {
    ...
    "finish when all inputs cancelled" in checkThatAllStagesAreStopped {
    ...
    "handle failure" in checkThatAllStagesAreStopped {
      val completionProbe = TestProbe()
      val p = FlowGraph.closed(out) { implicit b ⇒
        o ⇒
          val merge = b.add(new TestMerge(completionProbe.ref))
    ...
    "propagate failure" in checkThatAllStagesAreStopped {
      val publisher = PublisherProbe[String]
      val completionProbe = TestProbe()
      val p = FlowGraph.closed(out) { implicit b ⇒
        o ⇒
    ...
    "emit failure" in checkThatAllStagesAreStopped {
      val publisher = PublisherProbe[String]
      val completionProbe = TestProbe()
      val p = FlowGraph.closed(out) { implicit b ⇒
        o ⇒
    ...
    "emit failure for user thrown exception" in checkThatAllStagesAreStopped {
      val publisher = PublisherProbe[String]
      val completionProbe = TestProbe()
      val p = FlowGraph.closed(out) { implicit b ⇒
        o ⇒
    ...
    "emit failure for user thrown exception in onComplete" in checkThatAllStagesAreStopped {
      val publisher = PublisherProbe[String]
      val completionProbe = TestProbe()
      val p = FlowGraph.closed(out) { implicit b ⇒
        o ⇒
    ...
    "emit failure for user thrown exception in onUpstreamFinish 2" in checkThatAllStagesAreStopped {
      val publisher = PublisherProbe[String]
      val completionProbe = TestProbe()
      val p = FlowGraph.closed(out) { implicit b ⇒
        o ⇒
    ...
    "support finish from onInput" in checkThatAllStagesAreStopped {
      val publisher = PublisherProbe[String]
      val completionProbe = TestProbe()
      val p = FlowGraph.closed(out) { implicit b ⇒
        o ⇒
