...
class FlowFromFutureSpec extends AkkaSpec {
  ...
  "A Flow based on a Future" must {
    "produce one element from already successful Future" in checkThatAllStagesAreStopped {
    ...
    "produce error from already failed Future" in checkThatAllStagesAreStopped {
    ...
    "produce one element when Future is completed" in checkThatAllStagesAreStopped {
