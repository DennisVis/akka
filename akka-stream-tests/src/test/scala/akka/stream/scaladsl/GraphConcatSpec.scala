...
class GraphConcatSpec extends TwoStreamsSetup {
  ...
  "Concat" must {
    ...
    "work with one immediately completed and one nonempty publisher" in checkThatAllStagesAreStopped {
    ...
    "work with one delayed completed and one nonempty publisher" in checkThatAllStagesAreStopped {
    ...
    "work with one immediately failed and one nonempty publisher" in checkThatAllStagesAreStopped {
    ...
    "work with one nonempty and one delayed failed publisher" in checkThatAllStagesAreStopped {
    ...
    "work with one delayed failed and one nonempty publisher" in checkThatAllStagesAreStopped {
    ...
    "correctly handle async errors in secondary upstream" in checkThatAllStagesAreStopped {
