...
class FlowPrefixAndTailSpec extends AkkaSpec {
  ...
  "PrefixAndTail" must {
    ...
    "work on longer inputs" in checkThatAllStagesAreStopped {
      val futureSink = newHeadSink
    ...
    "handle zero take count" in checkThatAllStagesAreStopped {
      val futureSink = newHeadSink
    ...
    "work if size of take is equal to stream size" in checkThatAllStagesAreStopped {
      val futureSink = newHeadSink
    ...
    "handle onError when no substream open" in checkThatAllStagesAreStopped {
    ...
    "handle onError when substream is open" in checkThatAllStagesAreStopped {
      val publisher = StreamTestKit.PublisherProbe[Int]()
      val subscriber = StreamTestKit.SubscriberProbe[(immutable.Seq[Int], Source[Int, _])]()
    ...
    "handle master stream cancellation" in checkThatAllStagesAreStopped {
      val publisher = StreamTestKit.PublisherProbe[Int]()
      val subscriber = StreamTestKit.SubscriberProbe[(immutable.Seq[Int], Source[Int, _])]()
    ...
    "handle substream cancellation" in checkThatAllStagesAreStopped {
      val publisher = StreamTestKit.PublisherProbe[Int]()
      val subscriber = StreamTestKit.SubscriberProbe[(immutable.Seq[Int], Source[Int, _])]()
