...
class StreamTcpSpec extends AkkaSpec with TcpHelper {
  ...
  "Outgoing TCP stream" must {
    ...
    "work in the happy case" in checkThatAllStagesAreStopped {
    ...
    "work when client closes write, then remote closes write" in checkThatAllStagesAreStopped {
      val testData = ByteString(1, 2, 3, 4, 5)
      val server = new Server()
    ...
    "work when remote closes write, then client closes write" in checkThatAllStagesAreStopped {
      val testData = ByteString(1, 2, 3, 4, 5)
      val server = new Server()
    ...
    "work when client closes read, then client closes write" in checkThatAllStagesAreStopped {
      val testData = ByteString(1, 2, 3, 4, 5)
      val server = new Server()
    ...
    "work when client closes write, then client closes read" in checkThatAllStagesAreStopped {
      val testData = ByteString(1, 2, 3, 4, 5)
      val server = new Server()
    ...
    "work when client closes read, then server closes write, then client closes write" in checkThatAllStagesAreStopped {
      val testData = ByteString(1, 2, 3, 4, 5)
      val server = new Server()
    ...
    "shut everything down if client signals error" in checkThatAllStagesAreStopped {
      val testData = ByteString(1, 2, 3, 4, 5)
      val server = new Server()
    ...
    "shut everything down if client signals error after remote has closed write" in checkThatAllStagesAreStopped {
      val testData = ByteString(1, 2, 3, 4, 5)
      val server = new Server()
    ...
    "shut down both streams when connection is aborted remotely" in checkThatAllStagesAreStopped {
